	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	<li class="nav-item"><a href="DoctorHome.jsp" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item active"><a href="PatientsAppointment.jsp" class="nav-link">Appointments</a></li>
