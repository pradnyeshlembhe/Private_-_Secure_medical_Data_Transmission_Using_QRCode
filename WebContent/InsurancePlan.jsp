...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/dinsu1.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Insurance Section</h1>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url(images/dinsu.jpg);">
					</div>
					<div class="col-md-7 wrap-about py-4 py-md-5 ftco-animate">
	          <div class="heading-section mb-5">
	          	<div class="pl-md-5 ml-md-5 pt-md-5">
		            <h2 class="mb-2" style="font-size: 32px;">Insurance Section</h2>
           ...
           <table align="center" border="10" cellpadding="10px" cellspacing="0px">
				...
				%>
		            <tr>
		            	<th><b>Insurance Plan for Patient</b></th>
		           		<th><b>Smart Card No.</b></th>
						<td><%=session.getAttribute("SmartCardNo") %></td>
		            </tr>
		            <tr align="center">
			            <th><b>Policy</b></th>
			            <th><b>What is it?</b></th>
						<th><b>Dental Insurance Cover</b></th>
					</tr>
					<tr>
						<td></td>
						<td></td>
